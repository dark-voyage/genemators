                    ...
                    <div className="max-w-screen-lg mx-auto px-4 sm:px-6 md:px-8 pt-4">
                        <div className="text-white mt-4 sm:mt-8 break-words">
                            <p>
                                ...
                                is a project explorer that helps users to
                                explore projects created or contributed by{" "}
                                <InlineCode>Genemator Sakhib</InlineCode>. Outer
                                projects like{" "}
                                <InlineCode>
                                    organisation based projects
                                </InlineCode>{" "}
                                are also counted as Genemator's work.
                            </p>
                        </div>
                        <div className="mt-12">
                            <label
