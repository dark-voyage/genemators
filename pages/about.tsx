    ...
    return (
        <>
            <Head>
                ...
                <meta
                    property="og:title"
                    content="Information about Genemator"
                />
                <meta
                    ...
                    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="lg:text-center">
                            ...
                            <p className="mt-4 max-w-2xl text-xl leading-7 text-gray-300 lg:mx-auto">
                                ...
                                . I’m glad to see you visit my website. For the
                                beginning, let me introduce myself. I’m a Senior
                                Full-Stack developer with more than 7 years of
                                experience. Although I professionally code using
                                7 different programming languages as JavaScript,
                                TypeScript, Java, Kotlin, C, C++, Assembler,
                                Python2, Python3. I mainly use C++ for its total
                                control and wide range of functions. That said,
                                my knowledge is not limited to coding. I am also
                                a specialist in creating 3D driven video and
                                photo. Besides, I prefer Cinema 4D as 3D engine
                                and utilize Adobe Products for editing purposes.
                                I can also create different songs and music for
                                my projects by using special applications on a
                                professional level. For the time being, I am a
                                second-year student at Westminster International
                                University in Tashkent. My nationality is{" "}
                                <span className="text-blue-500">Uz</span>
                                <span className="text-red-500">b</span>
                                <span className="text-green-400">ek</span> and
                ...
                <div className="py-12">
                    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="lg:text-center">
                            ...
                            <p className="mt-4 max-w-2xl text-xl leading-7 text-gray-300 lg:mx-auto">
                                As everybody knows, there are multiple
                                directions in IT sphere and all of them
                                specialize in some kind of skills.
                            </p>
                        </div>
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="mt-2 text-base leading-6 text-gray-300">
                                                With the help of trendy
                                                JavaScript frameworks as React,
                                                Vue or maybe Next.JS I can build
                                                speedy and beautifully designed
                                                web apps with out-of-box
                                                functionalities.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <li className="mt-10 md:mt-0">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="mt-2 text-base leading-6 text-gray-300">
                                                I am able to build up my own
                                                server from zero to hero with
                                                various programming languages
                                                and frameworks. For example,
                                                Express.js on Node.js, Django or
                                                Flask on Python, also Oak on
                                                Deno.land
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <li className="mt-10 md:mt-0">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="mt-2 text-base leading-6 text-gray-300">
                                                Thanks for database programming
                                                knowledge, I have possibilities
                                                to create server with fully
                                                integrated datasets. As an
                                                example, postgresql, mysql,
                                                vanilla sql and so on.
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li className="mt-10 md:mt-0">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="mt-2 text-base leading-6 text-gray-300">
                                                With my knowledge on C, C++ or
                                                Python programming languages, I
                                                can build ready setup & build
                                                scripts, startups or unit tests
                                                for project.
                                            </p>
                                        </div>
                                    </div>
